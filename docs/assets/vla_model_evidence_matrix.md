...
- Upstream: OpenVLA
- Next step: Local 4-bit GPU, remote /v1/predict, and a ROS2 remote trace are all verified; next, broaden to task-level probes on real scene frames.
