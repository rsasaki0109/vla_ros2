...
- Next step: Local GPU inference and a real remote /v1/predict are both verified; next, record a ROS2 remote trace against the server, then broaden task probes.
