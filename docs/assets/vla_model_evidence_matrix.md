...
| Remote server | planned | Server command can be generated; recorded SmolVLA /v1/predict run is still needed.<br>[GPU server plan](sample_compare_suite/gpu_server_plan.md) |
