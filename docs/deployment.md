...
exposes a different memory-fit knob. The footprints below are **measured** on an RTX 4070 Ti
SUPER (16 GB) and are runtime-path numbers, not a task-success claim.
