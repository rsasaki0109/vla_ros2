...
- `vla_zoo/ros2/BRINGUP.md`
- `vla_zoo/ros2/vla_ros2/config/bringup.dashcam.example.yaml`
- `vla_zoo/scripts/bringup_validate.sh`
- `vla_zoo/scripts/publish_instruction.py`
