...
- `/media/sasaki/aiueo/ai_coding_ws/vla_zoo/scripts/vla_gz_env.sh`
- `/media/sasaki/aiueo/ai_coding_ws/vla_zoo/scripts/record_gz_smolvla_compare.sh`
- `/media/sasaki/aiueo/ai_coding_ws/vla_zoo/docs/assets/gz_smolvla_compare_metrics.json`
