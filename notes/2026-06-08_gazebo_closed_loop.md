...
1. ~~SmolVLA fine-tune（20k steps）→ GIF 差し替え~~ Done (`checkpoints/smolvla_so100_stacking_20k/checkpoints/020000/`)
...
- `vla_zoo/ros2/SIM.md`
- `vla_zoo/scripts/gz_smoke_validate.sh`
- `vla_zoo/scripts/gz_smoke_probe.py`
- `vla_zoo/ros2/vla_ros2_gz/launch/gz_arm.launch.py`
