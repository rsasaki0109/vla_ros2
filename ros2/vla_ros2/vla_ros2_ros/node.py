...
from vla_ros2_msgs.msg import VLAInstruction as VLAInstructionMsg
...
from vla_ros2.runtime.diagnostics import RuntimeDiagnostics
...
from vla_ros2_ros.converters import action_to_msg, chunk_to_msg, ros_image_to_numpy, status_to_msg
from vla_ros2_ros.params import RuntimeNodeParams
...
class VLARuntimeNode(Node):
    ...
    def _create_instruction_subscription(self) -> None:
        ...
        if msg_type == "string":
            ...
            return
        if msg_type in {"vla_instruction", "vla_ros2_msgs/VLAInstruction"}:
            self.create_subscription(
                VLAInstructionMsg,
                self.params.instruction_topic,
    ...
    def _vla_instruction_cb(self, msg: VLAInstructionMsg) -> None:
        self._set_instruction(
            ...
            source="vla_ros2_msgs/VLAInstruction",
        )
    ...
    def _publish_diagnostics(self) -> None:
        ...
        status.name = "vla_ros2/vla_runtime_node"
