...
_BUILTINS: dict[str, AdapterInfo] = {
    ...
    "pi0": AdapterInfo(
        ...
        metadata={
            ...
            "output": "policy-specific manipulation action",
            "action_space": "eef_delta",
            "action_shape": "(7,) placeholder",
            "control_hz": "policy/server dependent",
            "action_chunks": "expected",
            "proprioception": "expected",
            "local_runtime": "not implemented in MVP",
            "remote_runtime": "recommended",
            "dependency_profile": "openpi stack in serving environment",
    ...
    "smolvla": AdapterInfo(
        ...
        metadata={
            ...
            "compare_role": "multi-camera/state/action-chunk adapter target",
            "input_requirements": (
                "multi-camera images",
                "natural language instruction",
                "robot state",
            ),
            "output": "policy-specific action chunk",
            "action_space": "eef_delta",
            "action_shape": "(7,) placeholder",
            "control_hz": "policy/server dependent",
            "action_chunks": "expected",
            ...
            "local_runtime": "not implemented in MVP",
            "remote_runtime": "recommended",
            "dependency_profile": "LeRobot stack in serving environment",
